...
%\hline
%\emph{Completeness:} Do you have enough graphs/tables, and do your graphs/tables seem to have enough data to properly explore the topic of the lab?  &  \\
%\hline
%\emph{Graph/table Design:} Do you graphs/tables look nice and are they easy to understand? &  \\
%\hline
...
%\textbf{Bonus} &  \\
%\hline
%\emph{Error Calculations:} Do you include calculations of error derived from your measurements; are your errors displayed in your graphs? &  \\
%\hline
%\textbf{Total} &  \\
%\hline
%\end{tabular}
