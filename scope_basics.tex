...
\begin{itemize}
	\setlength\itemsep{1pt}
	\item Place the sample on the microscope stage carefully.
...
\begin{itemize}
	...
	\item Always start with a low magnification objective: find, center, then focus on the sample before moving on to a higher magnification.
...
\begin{itemize}
	\setlength\itemsep{1pt}
	\item Adjust the switching rod to go from eyepiece-only to dual-view mode.
